...
Page({
  ...
  viewTaped: function (e) {
    ...
    var statistics = level == "接单人" ? thatStatistics.complainStatisticsProject[index] : thatStatistics.complainStatisticsProject[index];
    var stringStatistics = JSON.stringify(statistics);
    wx.navigateTo({
      url: '../complainStatisticsDetail/complainStatisticsDetail?level=' + level + "&statistics=" + stringStatistics,
    })
  },
