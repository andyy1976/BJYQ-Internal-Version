...
Page({
  ...
  viewTaped: function (e) {
    ...
    var statistics = thatStatistics.equipmentStatisticsProjects[index];
    var stringStatistics = JSON.stringify(statistics);
    wx.navigateTo({
      url: '../equipmentStatisticsDetail/equipmentStatisticsDetail?level=' + level + "&statistics=" + stringStatistics,
    })
  },
